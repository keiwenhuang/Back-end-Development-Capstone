...
def songs(request):
    dummy = [{"id":1,"title":"duis faucibus accumsan odio curabitur convallis","lyrics":"Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis."}]
    songs = {"songs": dummy}
    return render(request, "songs.html", {"songs": dummy})
